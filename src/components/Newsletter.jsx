        ...
        <div className='w-full py-16 text-white px-4'>
            <div className='max-w-[1260px] mx-auto grid lg:grid-cols-3'>
                <div className='lg:col-span-2 py-4'>
                    ...
                    <p>Sign up to our newsletter and stary up to date</p>
                </div>
                <div className='my-4'>
                    ...
                    <p>We care about he protection of your data. Read our <span className='text-[#00df9a]'>Privacy Policy.</span></p>
                </div>
            </div>
